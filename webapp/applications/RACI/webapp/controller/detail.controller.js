    ...
    return Controller.extend("mdg_raci.RACI.controller.detail", {
      onInit: function () {
        ...
        if (!this.valueHelpForConfirmation)
          this.valueHelpForConfirmation = new sap.ui.xmlfragment(
            "mdg_raci.RACI.fragment.valueHelpForConfirmation",
            this
          );
      ...
      selectedObjectRaci: function (sObjectId) {
        ...
        $.ajax({
          url:
            "/OptimalCog/api/m-programs?filters[id][$eq]=" +
            sObjectId +
            "&populate=*",
          ...
          success: function (res) {
            ...
            if (programDetail.error) {
              MessageBox.error(
                programDetail.error.message + "Something went wrong!"
              );
            } else {
        ...
        $.ajax({
          url:
            "/OptimalCog/api/m-racis?filters[type][$eq]=PPR&filters[m_program][id][$eq]=" +
            sObjectId +
          ...
          success: function (res) {
            ...
            if (getValues.error) {
              MessageBox.error(
                getValues.error.message + "Something went wrong!"
              );
            } else {
        ...
        $.ajax({
          url:
            "/OptimalCog/api/m-racis?filters[type][$eq]=CSFR&filters[m_program][id][$eq]=" +
            sObjectId +
          ...
          success: function (resss) {
            ...
            if (CSFRdata.error) {
              MessageBox.error(
                CSFRdata.error.message + "Something went wrong!"
              );
            } else {
      ...
      RaciModelMain: function () {
        ...
        $.ajax({
          url:
            "/OptimalCog/api/m-racis?filters[id][$eq]=" +
            that.sObjectId +
          ...
          success: function (res) {
            ...
            if (racimodel.error) {
              MessageBox.error(
                racimodel.error.message + "Something went wrong!"
              );
            } else {
      ...
      getTheusers: function () {
        ...
        $.ajax({
          ...
          success: function (res) {
            ...
            if (userInfo.error) {
              MessageBox.error(
                userInfo.error.message + "Something went wrong!"
              );
            } else {
      ...
      onAddRaci: function () {
        var that = this;
        if (!this.AddRaci) {
          this.AddRaci = sap.ui.xmlfragment(
            "mdg_raci.RACI.fragment.AddRaci",
            this
          );
        ...
        var mmModel = new sap.ui.model.json.JSONModel(
          this.getView()
            .getModel("programDetails")
            .getData()[0].attributes.m_projects.data
        );
      ...
      onAddRaciPPR: function () {
        var that = this;
        if (!this.addRaciPPR) {
          this.addRaciPPR = sap.ui.xmlfragment(
            "mdg_raci.RACI.fragment.addRaciPPR",
            this
          );
          this.getView().addDependent(this.AddRacci);
        }
      ...
      handleAddRaciPress: function (oEvent) {
        ...
        if (
          selectedData.getContent()[1].getSelectedKey() !== "" &&
          selectedData.getContent()[3].getSelectedKey() !== ""
        ) {
          that.raciData = {
            ...
            status: "New",
            m_program: [
              this.getView().getModel("programDetails").getData()[0].id,
            ],
          };
          ...
          if (AddOrUpdate == "Add") {
            ...
            that.tdata = {
              m_project: [
                Number(selectedData.getContent()[1].getSelectedKey()),
              ],
              m_csf: [Number(selectedData.getContent()[3].getSelectedKey())],
            ...
            $.ajax({
              ...
              success: function (res) {
                ...
                if (getValues.error) {
                  MessageBox.error(
                    getValues.error.message +
                      "data is not Added Something went wrong!"
                  );
                } else {
                  that
                    .getView()
                  ...
                  $.ajax({
                    ...
                    data: JSON.stringify({
                      data: {
                        mraci: [
                          that.getView().getModel("CSFRmodel").getData().id,
                        ],
                        users_permissions_users: [
                          Number(that.consultedidforcheck),
                        ],
                      },
                    }),
                    success: function (res) {
                      ...
                      if (getValues.error) {
                        MessageBox.error(
                          getValues.error.message +
                            "data is not Updated Something went wrong!"
                        );
                      } else {
                        that
                          .getView()
                              ...
                              $.ajax({
                                ...
                                data: JSON.stringify({
                                  data: {
                                    ...
                                    users_permissions_users: [
                                      Number(that.informedidforcheck),
                                    ],
                                  },
                                }),
                                success: function (res) {
                                    ...
                                    $.ajax({
                                      ...
                                      data: JSON.stringify({
                                        data: {
                                          ...
                                          users_permissions_users: [
                                            Number(that.responsibleidforcheck),
                                          ],
                                        },
                                      }),
                                      success: function (res) {
            ...
            var mResponsibleId =
              that.mRaciModel.attributes.m_responsible.data.id;
            var mAccountableId =
              that.mRaciModel.attributes.m_accountable.data.id;
            ...
            $.ajax({
              ...
              data: JSON.stringify({
                ...
                data: {
                  users_permissions_users: [
                    Number(selectedData.getContent()[5].getSelectedKey()),
                  ],
                },
              }),
              success: function (res) {
                ...
                var user =
                  that.mRaciModel.attributes.m_accountable.data.attributes
                    .users_permissions_users.data[0].attributes.firstName;
                $.ajax({
                  url:
                    "/OptimalCog/api/m-accountables/" +
                    mAccountableId +
                    "?populate=*",
                  type: "PUT",
                  headers: {
                  ...
                  success: function (res) {
                    var user =
                      that.mRaciModel.attributes.m_consulted.data.attributes
                        .users_permissions_users.data[0].attributes.firstName;
                    $.ajax({
                      url:
                        "/OptimalCog/api/m-consulteds/" +
                        mConsultedId +
                        "?populate=*",
                      type: "PUT",
                      headers: {
                      ...
                      success: function (res) {
                        var user =
                          that.mRaciModel.attributes.m_informed.data.attributes
                            .users_permissions_users.data[0].attributes
                            .firstName;
                        $.ajax({
                          url:
                            "/OptimalCog/api/m-informeds/" +
                            mInformedId +
                            "?populate=*",
                          type: "PUT",
                          headers: {
      ...
      handleAddRaciPPRPress: function (oEvent) {
        ...
        if (
          ...
          that.raciData = {
            m_project: [Number(selectedData.getContent()[1].getSelectedKey())],
            m_assignment: [
              Number(selectedData.getContent()[3].getSelectedKey()),
            ],
            m_program: [
              this.getView().getModel("programDetails").getData()[0].id,
            ],
                ...
                if (getValues.error) {
                  ...
                  $.ajax({
                    ...
                    data: JSON.stringify({
                      data: {
                        mraci: [
                          that.getView().getModel("PPRmodel").getData().id,
                        ],
                        users_permissions_users: [
                          Number(that.consultedidforcheck),
                        ],
      ...
      handleDraftPress: function () {
        ...
        var that = this;
        var status = this.getView().getModel("programDetails").getData()[0]
          .attributes.mracis.data[0].attributes.status;
        if (status == "Submitted") {
      ...
      handleSubmitPress: function () {
        ...
        var initialStatus = this.getView()
          .getModel("programDetails")
          .getData()[0].attributes.mracis.data[0].attributes.status;
      ...
      handleEditItemPPRPress: function (evt) {
        ...
        this.addRaciPPR
          .getContent()[0]
          .getContent()[1]
          .setSelectedKey(that.mRaciModel.attributes.m_project.data.id);
        var selProjIndex = that.mRaciModel.attributes.m_project.data.id;
        that.addRaciPPR
          .getContent()[0]
          .getContent()[3]
          .setSelectedKey(
            that.mRaciModel.attributes.m_assignment.data === null
              ? []
              : that.mRaciModel.attributes.m_assignment.data.id
          );
        ...
        that.addRaciPPR
          ...
          .getContent()[5]
          .setSelectedKey(
            that.mRaciModel.attributes.m_responsible.data.attributes
              .users_permissions_users.data.length === 0
              ? []
              : that.mRaciModel.attributes.m_responsible.data.attributes
                  .users_permissions_users.data[0].id
          );
        that.addRaciPPR
          .getContent()[0]
          .getContent()[7]
      ...
      onProjectChange: function (oEvent) {
        ...
        $.ajax({
          url:
            "/OptimalCog/api/m-csfs?populate=*&filters[m_project][id][$eq]=" +
            selProjIndex,
          type: "GET",
          success: function (res) {
        ...
        $.ajax({
          ...
          success: function (res) {
            ...
            if (teamModel.error) {
              MessageBox.error(
                teamModel.error.message + "Something went wrong!"
              );
            } else {
      ...
      onProjectChangePPR: function (oEvent) {
        ...
        $.ajax({
          ...
          success: function (res) {
            ...
            if (pprDetails.error) {
              MessageBox.error(
                pprDetails.error.message + "Something went wrong!"
              );
            } else {
      ...
      handleEditItemPress: function (evt) {
        ...
        this.AddRaci.setModel(mmModel, "projectData");
        this.AddRaci.getContent()[0]
          .getContent()[1]
          .setSelectedKey(that.mRaciModel.attributes.m_project.data.id);
        var selProjIndex = that.mRaciModel.attributes.m_project.data.id;
        that.AddRaci.getContent()[0]
          .getContent()[3]
          .setSelectedKey(
            that.mRaciModel.attributes.m_csf.data === null
              ? []
              : that.mRaciModel.attributes.m_csf.data.id
          );
      ...
      handleDeleteRaci: function (oEvent) {
        ...
        if (selectedItems.length > 0) {
          MessageBox.confirm(
            "Are you sure you want to delete the selected CSFRs?",
            {
      ...
      handleDeleteRaciPPR: function (oEvent) {
        ...
        if (selectedItems.length > 0) {
          MessageBox.confirm(
            "Are you sure you want to delete the selected PPRs?",
            {
              title: "Confirm Deletion",
              icon: MessageBox.Icon.WARNING,
              actions: [MessageBox.Action.YES, MessageBox.Action.NO],
      ...
      createColumns: function () {
        return [
          ...
          },
          {
            label: "Responsible",
            property:
              "attributes/m_responsible/data/attributes/users_permissions_users/data/0/attributes/firstName",
          },
          {
            label: "Accountable",
            property:
              "attributes/m_accountable/data/attributes/users_permissions_users/data/0/attributes/firstName",
          },
          {
            label: "Consulted",
            property:
              "attributes/m_consulted/data/attributes/users_permissions_users/data/0/attributes/firstName",
          },
          {
            label: "Informed",
            property:
              "attributes/m_informed/data/attributes/users_permissions_users/data/0/attributes/firstName",
          },
        ];
      },
      ...
      handleApproveConfirm: function () {
        var that = this;
        var selectedKey = this.valueHelpForConfirmation
          .getContent()[0]
          .getContent()[3]
          .getSelectedKey();
      ...
      handleApproveButtonPress: function () {
        ...
        sap.m.MessageBox.confirm(
          "Do you want to approve the RACI?",
          function (oEvent) {
            if ((oEvent = "OK")) {
      ...
      handleRejectButtonPress: function () {
        var that = this;
        sap.m.MessageBox.confirm(
          "Do you want to reject the RACI?",
          function (oEvent) {
            if ((oEvent = "OK")) {
      ...
      handleStatus: function (result) {
        var StatusPr = this.getView().getModel("programDetails").getData()[0]
          .attributes.mracis.data[0].attributes.status;
